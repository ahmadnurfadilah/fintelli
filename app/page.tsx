  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-rose-50 to-white">
      ...
      <header className="relative overflow-hidden">
        ...
        <div className="absolute -bottom-1/2 left-1/2 transform -translate-x-1/2 w-[200%] aspect-[4/1] bg-gradient-to-b from-rose-50 to-transparent -z-10 rounded-[100%]" />
      </header>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-tr from-rose-600/20 to-transparent rounded-lg" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-rose-600">
        <div className="container mx-auto px-6 text-center">
          ...
          <Link href="/auth" className="bg-white text-rose-600 px-8 py-4 rounded-lg hover:bg-rose-50 transition-colors font-semibold">
            Get Started Now
          </Link>
        </div>
      </section>
